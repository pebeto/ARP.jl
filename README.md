# ARP.jl [![Build Status](https://github.com/pebeto/ARP.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/pebeto/ARPJulia.jl/actions/workflows/CI.yml?query=branch%3Amain)
